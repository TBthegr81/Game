...
public class Resources {
	...
	private static Array<Texture> Buttons = new Array<Texture>();
	...
	public static void loadFonts()
	{
		...
		Fonts.add(new BitmapFont(Gdx.files.internal("Fonts/EucrosiaUPC.fnt"),
		        Gdx.files.internal("Fonts/EucrosiaUPC.png"), false));
	}
	
	public static void loadButtons()
	{
		Buttons.add(new Texture(Gdx.files.internal("Menu_Button.png")));
		Buttons.add(new Texture(Gdx.files.internal("Menu_Button_Left.png")));
		Buttons.add(new Texture(Gdx.files.internal("Menu_Button_Right.png")));
        Buttons.add(new Texture(Gdx.files.internal("whitebox.png")));
        Buttons.add(new Texture(Gdx.files.internal("selected_neon_large.png"))); 
        Buttons.add(new Texture(Gdx.files.internal("selected_neon_small.png")));
        Buttons.add(new Texture(Gdx.files.internal("Menu_Button.png")));
	}
	...
	public static Array<Texture> getButtons()
	{
		return Buttons;
	}
